...
class ConfigLoadingTests(unittest.TestCase):
    ...
    def test_load_settings_ignores_directory_config_path(self) -> None:
        with tempfile.TemporaryDirectory() as tmp_dir:
            ...
            old_env_auth_key = module.os.environ.get("GPT_IMAGE_AUTH_KEY")
            try:
                module.BASE_DIR = base_dir
                module.DATA_DIR = data_dir
                module.CONFIG_FILE = config_dir
                module.os.environ["GPT_IMAGE_AUTH_KEY"] = os_auth_key
                ...
                if old_env_auth_key is None:
                    module.os.environ.pop("GPT_IMAGE_AUTH_KEY", None)
                else:
                    module.os.environ["GPT_IMAGE_AUTH_KEY"] = old_env_auth_key
