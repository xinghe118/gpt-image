    ...
    <section className="page-shell-wide space-y-5">
      <section className="flex flex-col gap-4 lg:flex-row lg:items-start lg:justify-between">
        ...
        <div className="flex flex-wrap items-center gap-2 lg:justify-end">
          ...
          <Button
            variant="outline"
            className="h-10 max-w-full rounded-xl border-stone-200 bg-white/80 px-4 text-stone-700 hover:bg-white"
      ...
      <section className="space-y-4">
        <div className="flex flex-col gap-3 lg:flex-row lg:items-center lg:justify-between">
          ...
          <div className="grid gap-2 sm:grid-cols-2 lg:flex lg:flex-row lg:items-center">
